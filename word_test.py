...
class WordTest(unittest.TestCase):
    ...
    def test_is_palindrome(self):
        ...
        input_word = Word('yriiryyriiryyriiryyriiryyriiryyriiryyri'
                          'iryyriiryyriiryyriiryyriiry'
                          'yriiryyriiryyriiryyriiryyriiry')
        self.assertTrue(input_word.is_palindrome(1))
        ...
        self.assertTrue(input_word.is_palindrome(5))
