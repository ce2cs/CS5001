...
class TestGradebook(TestCase):
    ...
    def test_average_grade(self):
        ...
        actual_average_grade = sum_of_grade / (
                self.students_number * self.assignments_number
        )
    ...
    def test_letter_grade(self):
        ...
        for student in self.students:
            student_avg_grade = sum(self.grades[student]) / \
                                self.assignments_number
        ...
        self.assertEqual(self.gb.letter_grade(self.assignments_number),
                         actual_letter_grade)
